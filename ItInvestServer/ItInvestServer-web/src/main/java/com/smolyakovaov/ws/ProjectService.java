...
public class ProjectService {
    ...
    @WebMethod(operationName = "listProjectsByProjectgroup")
    public List<Project> listProjectsByProjectgroup(@WebParam(name = "id") int id) {
        return ejbRef.listProjectsByProjectgroup(id);
    }
}
